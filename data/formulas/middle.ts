...
export const MIDDLE_FORMULAS: Formula[] = [
    ...
    realLife: [
      {
        icon: '📡',
        title: 'GPS 위치 측정',
        desc: 'GPS 위성은 3차원 피타고라스 정리를 사용해 위치를 계산해. 위성 3~4개의 거리로 삼각측량하는 원리야.',
      },
      {
        icon: '🎮',
        title: '게임 엔진 충돌 감지',
        desc: '게임 엔진은 두 객체 사이 거리를 피타고라스 정리로 계산해. 거리가 일정 이하면 충돌 판정!',
      },
      {
        icon: '🏗️',
        title: '건축 직각 확인',
  ...
  // ============================================================
  {
    ...
    example: {
      question: '학생 20명의 점수를 10점 간격 도수분포표로 만들었다. 70~80점이 7명으로 가장 많을 때, 이 계급의 계급값을 구하라.',
